...
<head>
    ...
    <title>Order Checkout - Latinos PC</title>
                    ...
                    <tr class="item-row" data-id="<?= $item['id'] ?>">
                        ...
                        <td class="col-price" style="text-align: right;">
                            ...
                            <div class="no-print price-input-wrapper" style="display: flex; align-items: center; justify-content: flex-end; gap: 4px;">
                                ...
                                <input type="number" name="unit_prices[<?= $item['id'] ?>]" aria-label="Unit Price" value="<?= number_format($price, 2, '.', '') ?>" step="0.01" class="price-input" oninput="recalculateTotals()" style="width: 90px; text-align: right; height: 38px; padding: 0 10px; border: 1px solid var(--border-color); border-radius: 8px; font-weight: 700;">
                            </div>
                        </td>
