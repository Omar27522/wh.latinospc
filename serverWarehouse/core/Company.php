<?php
/**
 * Latinos PC Warehouse Systems - Company & Brand Configuration Helper
...
class Company {
    ...
    public static function getName() {
        return self::get('company_name', 'Latinos PC');
    }

    public static function getSystemName() {
        return self::get('system_name', 'Latinos PC Warehouse Systems');
    }
